...
class Game:
    ...
    def __init__(self):
        self.tk = Tk()
        self.tk.title('Person go in Exit')
...
#         self.canvas_width = 500
#         self.bg = PhotoImage(file='background.gif')
#         self.bg2 = PhotoImage(file='figure-L1.gif')
#         w = self.bg.width()
#         h = self.bg.height()
...
class Coords:
    ...
    def __init__(self, x1=0, y1=1, x2=0, y2=0):
        self.x1 = x1
        self.y1 = y1
        self.x2 = x2
        self.y2 = y2
...
def collided_bottom(y, co1, co2):
    if within_x(co1, co2):
        y_ca1c = co1.y2 + y
        if y_ca1c >= co2.y1 and y_ca1c <= co2.y2:
            return True
    return False
    ...
    def move(self):
        ...
        for sprite in self.game.sprites:
            ...
            if bottom and falling and self.y == 0 and co.y2 < self.game.canvas_height \
                and collided_bottom(2, co, sprite_co):
                falling = False
...
g = Game()
platform1 = PlatformSprite(g, PhotoImage(file="platform2.gif"), 0, 480, 100, 10)
platform2 = PlatformSprite(g, PhotoImage(file="platform2.gif"), 150, 440, 100, 10)
platform3 = PlatformSprite(g, PhotoImage(file="platform2.gif"), 300, 400, 100, 10)
platform4 = PlatformSprite(g, PhotoImage(file="platform2.gif"), 300, 160, 100, 10)
...
door = DoorSprites(g, PhotoImage(file='door1.gif'), 45, 30, 40, 35)
